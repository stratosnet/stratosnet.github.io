---
title: SDS Update to v0.12.10
description: SDS Update to v12 Documentation.
---

# SDS Update to v0.12.10

## Introduction

SDS v12.10 is an important update, if you run a SDS node for Stratos, it's recommended that you apply this update in order for your node to continue normal operations.
...
```
[INFO] config.go:122: Updated config version from v0.12.2 to v0.12.10
...
To facilitate this process, SDS v12.7 introduces a new terminal command that allows you to automatically delete all files stored by your node up to February 03, 2025, ensuring a clean and optimized storage environment.
